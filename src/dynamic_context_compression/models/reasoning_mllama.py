from transformers import MllamaForCausalLM, MllamaConfig
import torch
...
# =============================================================================
class ReasoningMllamaConfig(MllamaConfig):
    """
...
# =============================================================================
class ReasoningMllamaForCausalLM(MllamaForCausalLM):
    """
    ...
    config_class = ReasoningMllamaConfig

    def __init__(self, config: ReasoningMllamaConfig):
